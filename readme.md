...
As of 2025-12-09, it only works with QMK 0.26.11 or older, PCIO\_PIO\_USB 0.7.2 or older (multiple reset need for 0.7.0+, 0.6.1 or older are fine) and TinyUSB 0.17.0 or older. 
